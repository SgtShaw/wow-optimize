// ================================================================
// crashfix_87307d.cpp — Fix NULL deref in sub_873060 at 0x0087307D
// ================================================================
// Crash: ACCESS_VIOLATION at 0x0087307D reading 0x00000030
//
// Root cause: sub_873060 accesses dword_D43024 + a1*4 + 0x2C
// without checking if dword_D43024 is NULL. The flag dword_D43020
// is TRUE but dword_D43024 hasn't been set yet (race condition
// during early render init).
//
// Fix v2: When dword_D43024 is NULL, skip the ENTIRE function
// (not just the dereference). This prevents partial render state
// setup that leaves the pipeline in a corrupted state, causing
// secondary crashes at 0x7668D2 (string processing with bad this*).
//
// The dword_D43024 pointer is set by sub_872F90 when the render
// device is fully initialized. Until then, sub_873060 has nothing
// useful to do.
// ================================================================
