// SEH guard for sub_508320 (sound buffer access / chat-channel config)
// Catches ACCESS_VIOLATION in sound buffer code — returns safely instead of crashing.
// Also registers the "SndUpdate" feature alongside SndBuffer (same underlying function).
