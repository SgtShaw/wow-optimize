// luaV_settable inline — at 0x8573C0
// Optimizes the common case: string key + direct table + no __newindex.
// Skips the metatable loop and __newindex lookup in the engine.
// Falls back on: metatables, numeric keys, hash collisions, __newindex.
