// ================================================================
// crashfix_evict.cpp — Fix D3D EvictManagedResources assertion
// ================================================================
// ERROR #134 (0x85100086) "Fatal Condition" — "Driver internal error
// on EvictManagedResources()". DXVK returns D3DERR_DEVICEREMOVED
// during the 2D→3D device transition at world loading screen.
//
// Fix: Hook the two assertion check functions (CGxD3dDevice D3D9
// and D3D9Ex variants) and skip the fatal error dialog when the
// vtable call returns D3DERR_DEVICEREMOVED (-2005530585).
// ================================================================
