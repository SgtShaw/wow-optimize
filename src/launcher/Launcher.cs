    ...
    public class MainForm : Form {
        ...
        public MainForm() {
            ...
            settingsMap = new Dictionary<string, SettingItem>() {
                ...
                { "Null Pointer CVar Safeguard", new SettingItem("General", "CvarNullGuard", true, null, "Declines CVar writes through an object that looks uninitialised, which prevents a class of client crash. Also pins timingMethod to 2 and timingTestError to 0 whatever the client asks for - that part is not covered by the High-Precision Timing Fix setting despite the name, and your log now says so when it happens.") },
