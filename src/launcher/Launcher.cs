    ...
    public class MainForm : Form {
        ...
        public MainForm() {
            ...
            settingsMap = new Dictionary<string, SettingItem>() {
                ...
                { "GetSpellInfo Cache", new SettingItem("Combat_Net", "GetSpellInfoCache", false, null, "Caches GetSpellInfo results. Off by default, and worth checking if you have it on from an older version: it used to serve pre-talent-switch spell data - most visibly a WeakAuras icon that stayed wrong until /reload - because a reload was the only thing that cleared it. Entries now expire after a second, which bounds that, but this cache has never been measured to help anything.") },
