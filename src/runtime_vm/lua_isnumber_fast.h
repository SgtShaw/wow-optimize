...
// ============================================================================
// Module: lua_isnumber_fast.h
// Description: Accelerates Lua runtime calls in `lua_isnumber_fast.h`.
 ...
 * @architecture: Optimizes C-API transitions for Lua state queries in `lua_isnumber_fast.h`.
