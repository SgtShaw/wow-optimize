...
// ============================================================================
// Module: lua_yield_fast.h
// Description: Accelerates Lua runtime calls in `lua_yield_fast.h`.
 ...
 * @architecture: Optimizes C-API transitions for Lua state queries in `lua_yield_fast.h`.
