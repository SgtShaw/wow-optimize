...
#define CRASH_TEST_DISABLE_LUAH_GETSTR          1   // luaH_getstr (0x0085C430) string-key table lookup cache — DISABLED: stale Node* after table destroy causes 0xC0000005 at 0x0085BC2C and 0x0085C3B0
