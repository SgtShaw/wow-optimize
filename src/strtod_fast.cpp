// ================================================================
// Fast string-to-number conversion helper (strtod hook)
// ================================================================
// WoW's Lua VM calls sub_84D480 to parse numeric strings. That wrapper
// calls strtod (locale-sensitive, handles floats/exponents/hex).
// We detour sub_84D480 and provide a fast path for simple integer
// strings (trimmed, optional sign, only ASCII digits).
// ================================================================
