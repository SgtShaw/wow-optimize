...
// Description: Direct memory patching engine. Overwrites target function prologues with assembly jumps.
// Safety & Threading: Main thread initialization. Restore memory protection flags after write operations.
// ============================================================================
