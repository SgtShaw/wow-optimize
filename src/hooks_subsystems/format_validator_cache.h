...
// ============================================================================
// Module: format_validator_cache.h
// Description: Supporting utility functions for `format_validator_cache.h`.
 ...
 * @architecture: Implements helper methods and utility wrappers for `format_validator_cache.h`.
