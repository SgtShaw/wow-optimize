...
// ============================================================================
// Module: cdatastore_batch.h
// Description: Supporting utility functions for `cdatastore_batch.h`.
 ...
 * @architecture: Implements helper methods and utility wrappers for `cdatastore_batch.h`.
