...
// ============================================================================
// Module: tls_object_cache.h
// Description: Supporting utility functions for `tls_object_cache.h`.
 ...
 * @architecture: Implements helper methods and utility wrappers for `tls_object_cache.h`.
...
#ifndef TLS_OBJECT_CACHE_H
#define TLS_OBJECT_CACHE_H
